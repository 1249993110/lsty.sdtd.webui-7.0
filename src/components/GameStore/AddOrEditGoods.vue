<template>
    <el-dialog :title="isAdd ? '新增商品' : '编辑商品'" v-model="visible" width="650px">
        <el-form ref="formRef" :model="formModel" status-icon label-width="120px" label-position="right">
            ...
            <el-form-item label="购买命令" prop="buyCommand" required>
                <el-input v-model="formModel.buyCommand"></el-input>
            </el-form-item>
            <el-form-item class="label" :label="`执行指令\n(每行一条)`" prop="executeCommand" required>
                <el-input v-model="formModel.executeCommand" type="textarea" :rows="5"></el-input>
            </el-form-item>
